...
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://kavita:kavishah789@cluster0.q53d2hh.mongodb.net/?retryWrites=true&w=majority").then(() => {
...
app.get("/", (req, res) => {
    res.send("InstaClone Backend By kavita")
})
